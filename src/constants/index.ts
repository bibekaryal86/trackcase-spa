...
export const TYPE_IS_MISSING = 'SOMETHING WENT WRONG, TYPE NOT SET, PLEASE TRY AGAIN...'
export const TYPE_IS_INCORRECT = 'SOMETHING WENT WRONG, TYPE NOT SET CORRECTLY, PLEASE TRY AGAIN...'
