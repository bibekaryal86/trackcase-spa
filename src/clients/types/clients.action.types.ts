...
export const CLIENT_NOTE_REQUEST = 'CLIENT_NOTE_REQUEST'
export const CLIENT_NOTE_SUCCESS = 'CLIENT_NOTE_SUCCESS'
export const CLIENT_NOTE_FAILURE = 'CLIENT_NOTE_FAILURE'
