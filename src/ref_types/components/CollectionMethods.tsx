...
} from '../actions/collection_methods.action'
import { COLLECTION_METHODS_UNMOUNT } from '../types/ref_types.action.types'
import { CollectionMethodSchema } from '../types/ref_types.data.types'

const mapStateToProps = ({ collectionMethods }: GlobalState) => {
  return {
    collectionMethodsList: collectionMethods.collection_methods,
  }
}
