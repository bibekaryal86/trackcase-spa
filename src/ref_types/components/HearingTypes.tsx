...
import { addHearingType, deleteHearingType, editHearingType, getHearingTypes } from '../actions/hearing_types.action'
import { HEARING_TYPES_UNMOUNT } from '../types/ref_types.action.types'
import { HearingTypeSchema } from '../types/ref_types.data.types'

const mapStateToProps = ({ hearingTypes }: GlobalState) => {
  return {
    hearingTypesList: hearingTypes.hearing_types,
  }
}
